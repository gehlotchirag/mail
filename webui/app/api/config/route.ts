...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    faviconUrl: configManager.get<string>('faviconUrl', '/branding/Flux_Logo_Color.svg'),
    appLogoLightUrl: configManager.get<string>('appLogoLightUrl', ''),
    appLogoDarkUrl: configManager.get<string>('appLogoDarkUrl', ''),
    loginLogoLightUrl: configManager.get<string>('loginLogoLightUrl', '/branding/Flux_Logo_Color.svg'),
    loginLogoDarkUrl: configManager.get<string>('loginLogoDarkUrl', '/branding/Flux_Logo_White.svg'),
